...
assign subs[0][`vai(56,1)] = 56'dX;
assign subs[0][`vai(56,2)] = 56'dX;
assign subs[0][`vai(56,3)] = 56'dX;
`endif
...
logic [`va(AUDIO_BIT_WIDTH,2)] audio_sample_word_transfer;
